...
class OnBoardNewPasswordFragment : Fragment(), View.OnClickListener {
    override fun onClick(p0: View?) {
        ...
        if (p0 == btn_next_new_password_view) {
            ...
            if (Validator.passwordsMatch(edt_password, edt_confirm_password)) {
                if (Validator.isValidPin(edt_password)) {
                    verifyPassword()
                }
            }
        }
    ...
    private fun getOauth(): Oauth {
        ...
        oauth.profile?.password_repeat = Validator.getText(edt_password)
        return oauth
    ...
    private fun initWidgets() {
        ...
        edt_confirm_password.addTextChangedListener(PinTextWatcher(edt_confirm_password))
