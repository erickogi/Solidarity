...
public class IModelAdapter<T extends Searchable>
        extends RecyclerView.Adapter<IModelAdapter.ViewHolder> {
    ...
    public IModelAdapter(Context context, @LayoutRes int layout, List<T> items) {
        this(context, layout, null, items);
    }

    public IModelAdapter(
    ...
    public IModelAdapter<T> setViewBinder(AdapterViewBinder<T> viewBinder) {
        this.mViewBinder = viewBinder;
        return this;
    }
...
//        holder.txtT.text=t
    ...
    public IModelAdapter setSearchTag(String searchTag) {
    ...
    public IModelAdapter setHighlightPartsInCommon(boolean highlightPartsInCommon) {
        mHighlightPartsInCommon = highlightPartsInCommon;
        return this;
    }

    public IModelAdapter setHighlightColor(String highlightColor) {
        mHighlightColor = highlightColor;
        return this;
    }

    public IModelAdapter setSearchDialog(BaseSearchDialogCompat searchDialog) {
